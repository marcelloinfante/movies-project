...
ActiveRecord::Schema.define(version: 2021_10_28_165830) do
  ...
  create_table "movies_artists", id: false, force: :cascade do |t|
    t.bigint "movie_id"
    t.bigint "artist_id"
    t.index ["artist_id"], name: "index_movies_artists_on_artist_id"
    t.index ["movie_id"], name: "index_movies_artists_on_movie_id"
  end
  ...
  add_foreign_key "movies_artists", "artists"
  add_foreign_key "movies_artists", "movies"
